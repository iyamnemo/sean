...
//require_once 'function/category_controller.php';
                ...
                <div class="category-form">
                    ...
                    <div class="card">
                        <div class="card-content">
                            <form method="POST" action="function/category_controller.php">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a class="text-red-500 ml-16" href="function/category_controller.php?action=delete&id=<?= $category->id ?>">Delete</a>
                                </td>
                            </tr>
                            <?php endforeach; ?>
                        </tbody>
