    ...
    return function t(e, s, i) {
          ...
          var i = (function (t, e) {
            t.exports = function () {
              var t = 6e4, e = 36e5, s = "millisecond", i = "second", a = "minute", n = "hour", r = "day", o = "week", h = "month", l = "quarter", d = "year", c = "date", u = "Invalid Date", p = /^(\d{4})[-/]?(\d{1,2})?[-/]?(\d{0,2})[Tt\s]*(\d{1,2})?:?(\d{1,2})?:?(\d{1,2})?[.:]?(\d+)?$/, f = /\[([^\]]+)]|Y{1,4}|M{1,4}|D{1,2}|d{1,4}|H{1,2}|h{1,2}|a|A|m{1,2}|s{1,2}|Z{1,2}|SSS/g, g = {name: "en", weekdays: "Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split("_"), months: "January_February_March_April_May_June_July_August_September_October_November_December".split("_")}, m = function (t, e, s) {
                ...
                var i = 12 * (s.year() - e.year()) + (s.month() - e.month()), a = e.clone().add(i, h), n = s - a < 0, r = e.clone().add(i + (n ? -1 : 1), h);
                return +(-(i + (s - a) / (n ? a - r : r - a)) || 0);
              }, a: function (t) {
                return t < 0 ? Math.ceil(t) || 0 : Math.floor(t);
              }, p: function (t) {
                return {M: h, y: d, w: o, d: r, D: c, h: n, m: a, s: i, ms: s, Q: l}[t] || String(t || "").toLowerCase().replace(/s$/, "");
              }, u: function (t) {
                return undefined === t;
              }}, y = "en", v = {};
              v[y] = g;
              ...
              var $ = function () {
                function g(t) {
                  this.$L = C(t.locale, null, true), this.parse(t);
                }
                var m = g.prototype;
                return m.parse = function (t) {
                  ...
                  switch (u) {
                    ...
                    case r:
                    case c:
                      return M.w(s.toDate()[y + "Hours"].apply(s.toDate("s"), (l ? [0, 0, 0, 0] : [23, 59, 59, 999]).slice(0)), s);
                    case n:
                      return M.w(s.toDate()[y + "Minutes"].apply(s.toDate("s"), (l ? [0, 0, 0, 0] : [23, 59, 59, 999]).slice(1)), s);
                    case a:
                      return M.w(s.toDate()[y + "Seconds"].apply(s.toDate("s"), (l ? [0, 0, 0, 0] : [23, 59, 59, 999]).slice(2)), s);
                    case i:
                      return M.w(s.toDate()[y + "Milliseconds"].apply(s.toDate("s"), (l ? [0, 0, 0, 0] : [23, 59, 59, 999]).slice(3)), s);
                    default:
                      return this.clone();
                  }
                }, m.endOf = function (t) {
                  ...
                  var o, l = M.p(t), u = "set" + (this.$u ? "UTC" : ""), p = (o = {}, o[r] = u + "Date", o[c] = u + "Date", o[h] = u + "Month", o[d] = u + "FullYear", o[n] = u + "Hours", o[a] = u + "Minutes", o[i] = u + "Seconds", o[s] = u + "Milliseconds", o)[l], f = l === r ? this.$D + (e - this.$W) : e;
                  if (l === h || l === d) {
                  ...
                  if (p === r) return f(1);
                  if (p === o) return f(7);
                  var g = (c = {}, c[a] = t, c[n] = e, c[i] = 1e3, c)[p] || 1, m = this.$d.getTime() + s * g;
                  return M.w(m, this);
                  ...
                  var i = t || "YYYY-MM-DDTHH:mm:ssZ", a = M.z(this), n = this.$H, r = this.$m, o = this.$M, h = s.weekdays, l = s.months, p = s.meridiem || function (t, e, s) {
                    var i = t < 12 ? "AM" : "PM";
                    return s ? i.toLowerCase() : i;
                  }, g = {YY: String(this.$y).slice(-2), YYYY: this.$y, M: o + 1, MM: M.s(o + 1, 2, "0"), MMM: s.monthsShort && (s.monthsShort[o] || s.monthsShort(e, i)) || l[o].substr(0, 3), MMMM: l && (l[o] || l(e, i)) || a[o].substr(0, n), D: this.$D, DD: M.s(this.$D, 2, "0"), d: String(this.$W), dd: s.weekdaysMin && (s.weekdaysMin[this.$W] || s.weekdaysMin(e, i)) || h[this.$W].substr(0, 2), ddd: s.weekdaysShort && (s.weekdaysShort[this.$W] || s.weekdaysShort(e, i)) || h[this.$W].substr(0, 3), dddd: h[this.$W], H: String(n), HH: M.s(n, 2, "0"), h: M.s(n % 12 || 12, 1, "0"), hh: M.s(n % 12 || 12, 2, "0"), a: p(n, r, true), A: p(n, r, false), m: String(r), mm: M.s(r, 2, "0"), s: String(this.$s), ss: M.s(this.$s, 2, "0"), SSS: M.s(this.$ms, 3, "0"), Z: a};
                  ...
                  var p, f = M.p(c), g = x(s), m = (g.utcOffset() - this.utcOffset()) * t, b = this - g, y = M.m(this, g);
              ...
              return x.prototype = T, [["$ms", s], ["$s", i], ["$m", a], ["$H", n], ["$W", r], ["$M", h], ["$y", d], ["$D", c]].forEach(function (t) {
                ...
                return t.$i || (t(e, $, x), t.$i = true), x;
              }, x.locale = C, x.isDayjs = w, x.unix = function (t) {
                return x(1e3 * t);
              }, x.en = v[y], x.Ls = v, x.p = {}, x;
            }();
          }(e = {exports: {}}, e.exports), e.exports), a = (function (t, e) {
            t.exports = function () {
              var t = {LTS: "h:mm:ss A", LT: "h:mm A", L: "MM/DD/YYYY", LL: "MMMM D, YYYY", LLL: "MMMM D, YYYY h:mm A", LLLL: "dddd, MMMM D, YYYY h:mm A"}, e = /(\[[^[]*\])|([-:/.()\s]+)|(A|a|YYYY|YY?|MM?M?M?|Do|DD?|hh?|HH?|mm?|ss?|S{1,3}|z|ZZ?)/g, s = /\d\d/, i = /\d\d?/, a = /\d*[^\s\d-_:/()]+/, n = {}, o = function (t) {
                return function (e) {
                  this[t] = +e;
                };
                ...
                this.afternoon = d(t, false);
              }], a: [a, function (t) {
                this.afternoon = d(t, true);
              }], S: [/\d/, function (t) {
                ...
                this.milliseconds = +t;
              }], s: [i, o("seconds")], ss: [i, o("seconds")], m: [i, o("minutes")], mm: [i, o("minutes")], H: [i, o("hours")], h: [i, o("hours")], HH: [i, o("hours")], hh: [i, o("hours")], D: [i, o("day")], DD: [s, o("day")], Do: [a, function (t) {
                var e = n.ordinal, s = t.match(/\d+/);
                if (this.day = s[0], e) for (var i = 1; i <= 31; i += 1) (i(e = {exports: {}}, e.exports), e.exports).replace(/\[|\]/g, "") === t && (this.day = i);
              }], M: [i, o("month")], MM: [s, o("month")], MMM: [a, function (t) {
                ...
                this.month = e % 12 || e;
              }], Y: [/[+-]?\d+/, o("year")], YY: [s, function (t) {
                this.year = (t = +t) + (t > 68 ? 1900 : 2e3);
              }], YYYY: [/\d{4}/, o("year")], Z: h, ZZ: h};
              function u(s) {
                var i, a;
                i = s, a = n && n.formats;
              ...
              return function (t, e, s) {
                s.p.customParseFormat = true, t && t.parseTwoDigitYear && (r = t.parseTwoDigitYear);
                ...
                i.parse = function (t) {
                  ...
                  var o = r[1];
                  if ("string" == typeof o) {
                    var h = true === r[2], l = true === r[3], d = h || l, c = r[2];
                    l && (c = r[2]), n = this.$locale(), !h && c && (n = s.Ls[c]), this.$d = function (t, e, s) {
                      try {
                        if (["x", "X"].indexOf(e) > -1) return new Date(("X" === e ? 1e3 : 1) * t);
                        var i = u(e)(t), a = i.year, n = i.month, r = i.day, o = i.hours, h = i.minutes, l = i.seconds, d = i.milliseconds, c = i.zone, p = new Date, f = r || (a || n ? 1 : p.getDate()), g = a || p.getFullYear(), m = 0;
                    ...
                    }(e, o, i), this.init(), c && true !== c && (this.$L = this.locale(c).$L), d && e != this.format(o) && (this.$d = new Date("")), n = {};
      ...
      class h {
        ...
        add(t) {
          if (Array.isArray(t)) {
            ...
            }) : e.data.push(this.build(t)), e.data.length && (e.hasRows = true), this.update(), e.columns().rebuild();
          }
        }
        remove(t) {
          const e = this.dt;
          Array.isArray(t) ? (t.sort((t, e) => e - t), t.forEach(t => {
            e.data.splice(t, 1);
          })) : "all" == t ? e.data = [] : e.data.splice(t, 1), e.data.length || (e.hasRows = false), this.update(), e.columns().rebuild();
        }
        update() {
      ...
      class l {
        ...
        order(t) {
          ...
          const h = [[], [], [], []], l = this.dt;
          t.forEach((t, i) => {
            n = l.headings[t], r = "false" !== n.getAttribute("data-sortable"), e = n.cloneNode(true), e.originalCellIndex = i, e.sortable = r, h[0].push(e), l.hiddenColumns.includes(t) || (s = n.cloneNode(true), s.originalCellIndex = i, s.sortable = r, h[1].push(s));
          }), l.data.forEach((e, s) => {
            i = e.cloneNode(false), a = e.cloneNode(false), i.dataIndex = a.dataIndex = s, null !== e.searchIndex && undefined !== e.searchIndex && (i.searchIndex = a.searchIndex = e.searchIndex), t.forEach(t => {
              o = e.cells[t].cloneNode(true), o.data = e.cells[t].data, i.appendChild(o), l.hiddenColumns.includes(t) || (o = e.cells[t].cloneNode(true), o.data = e.cells[t].data, a.appendChild(o));
        ...
        add(t) {
          ...
          }), t.type && s.setAttribute("data-type", t.type), t.format && s.setAttribute("data-format", t.format), t.hasOwnProperty("sortable") && (s.sortable = t.sortable, s.setAttribute("data-sortable", true === t.sortable ? "true" : "false")), this.rebuild(), this.dt.renderHeader();
        }
        remove(t) {
        ...
        filter(t, e, s, i) {
          ...
          a.data = r, a.data.length ? (this.rebuild(), a.update()) : (a.clear(), a.hasRows = false, a.setMessage(a.options.labels.noRows)), s || a.emit("datatable.sort", t, e);
        }
        sort(e, s, i) {
          const a = this.dt;
          if (a.hasHeadings && (e < 0 || e > a.headings.length)) return false;
          const n = a.options.filters && a.options.filters[a.headings[e].textContent];
          if (n && 0 !== n.length) return void this.filter(e, s, i, n);
          a.sorting = true, i || a.emit("datatable.sorting", e, s);
          let r = a.data;
          const h = [], l = [];
          let d = 0, c = 0;
          ...
          Promise.all(p).then(t => {
            ...
            Array.from(r).forEach(t => {
              const s = t.cells[e], i = s.hasAttribute("data-content") ? s.getAttribute("data-content") : s.innerText;
              let a;
              a = n ? n(i) : "string" == typeof i ? i.replace(/(\$|,|\s|%)/g, "") : i, parseFloat(a) == a ? l[c++] = {value: Number(a), row: t} : h[d++] = {value: "string" == typeof i ? i.toLowerCase() : i, row: t};
            ...
            const g = [];
            r.forEach((t, e) => {
              a.data.push(t.row), null !== t.row.searchIndex && undefined !== t.row.searchIndex && g.push(e);
        ...
        rebuild() {
          ...
          a.activeRows = [], a.activeHeadings = [], a.headings.forEach((t, e) => {
            ...
            t = r.cloneNode(false), e = r.cloneNode(false), t.dataIndex = e.dataIndex = o, null !== r.searchIndex && undefined !== r.searchIndex && (t.searchIndex = e.searchIndex = r.searchIndex), Array.from(r.cells).forEach(n => {
              s = n.cloneNode(true), s.data = n.data, t.appendChild(s), a.hiddenColumns.includes(s.cellIndex) || (i = s.cloneNode(true), i.data = s.data, e.appendChild(i));
      ...
      }, c = {sortable: true, searchable: true, paging: true, perPage: 10, perPageSelect: [5, 10, 15, 20, 25], nextPrev: true, firstLast: false, prevText: "&lsaquo;", nextText: "&rsaquo;", firstText: "&laquo;", lastText: "&raquo;", ellipsisText: "&hellip;", ascText: "▴", descText: "▾", truncatePager: true, pagerDelta: 2, scrollY: "", fixedColumns: true, fixedHeight: false, header: true, hiddenHeader: false, footer: false, labels: {placeholder: "Search...", perPage: "{select} entries per page", noRows: "No entries found", noResults: "No results match your search query", info: "Showing {start} to {end} of {rows} entries"}, layout: {top: "{select}{search}", bottom: "{info}{pager}"}};
      class u {
        constructor(t, e = {}) {
          const s = "string" == typeof t ? document.querySelector(t) : t;
          if (this.options = {...c, ...e, layout: {...c.layout, ...e.layout}, labels: {...c.labels, ...e.labels}}, this.initialized = false, this.initialLayout = s.innerHTML, this.initialSortable = this.options.sortable, this.options.header || (this.options.sortable = false), null === s.tHead && (!this.options.data || this.options.data && !this.options.data.headings) && (this.options.sortable = false), s.tBodies.length && !s.tBodies[0].rows.length && this.options.data && !this.options.data.data) throw new Error("You seem to be using the data option, but you've not defined any rows.");
        ...
        init(t) {
          if (this.initialized || this.dom.classList.contains("dataTable-table")) return false;
          Object.assign(this.options, t || {}), this.currentPage = 1, this.onFirstPage = true, this.hiddenColumns = [], this.columnRenderers = [], this.selectedColumns = [], this.render(), setTimeout(() => {
            this.emit("datatable.init"), this.initialized = true, this.options.plugins && Object.entries(this.options.plugins).forEach(([t, e]) => {
        ...
        renderPager() {
          if (n(this.pagers), this.totalPages > 1) {
            const t = "pager", e = document.createDocumentFragment(), s = this.onFirstPage ? 1 : this.currentPage - 1, i = this.onLastPage ? this.totalPages : this.currentPage + 1;
        ...
        bindEvents() {
          ...
          t.searchable && (this.input = this.wrapper.querySelector(".dataTable-input"), this.input && this.input.addEventListener("keyup", () => this.search(this.input.value), false)), this.wrapper.addEventListener("click", e => {
          ...
          }, false), window.addEventListener("resize", this.listeners.onResize);
        }
        onResize() {
        ...
        setColumns(t) {
          t || this.data.forEach(t => {
            ...
            Array.isArray(t.select) || (t.select = [t.select]), t.hasOwnProperty("render") && "function" == typeof t.render && (this.selectedColumns = this.selectedColumns.concat(t.select), this.columnRenderers.push({columns: t.select, renderer: t.render})), t.select.forEach(e => {
              ...
              t.type && s.setAttribute("data-type", t.type), t.format && s.setAttribute("data-format", t.format), t.hasOwnProperty("sortable") && s.setAttribute("data-sortable", t.sortable), t.hasOwnProperty("hidden") && false !== t.hidden && this.columns().hide([e]), t.hasOwnProperty("sort") && 1 === t.select.length && this.columns().sort(t.select[0], t.sort, true);
            });
        ...
        destroy() {
          this.dom.innerHTML = this.initialLayout, this.dom.classList.remove("dataTable-table"), this.wrapper.parentNode.replaceChild(this.dom, this.wrapper), this.initialized = false, window.removeEventListener("resize", this.listeners.onResize);
        }
        update() {
          ...
          this.sorting = false, this.render("pager"), this.rows().update(), this.emit("datatable.update");
        }
        paginate() {
        ...
        search(t) {
          return !!this.hasRows && (t = t.toLowerCase(), this.currentPage = 1, this.searching = true, this.searchData = [], t.length ? (this.clear(), this.data.forEach((e, s) => {
            const i = this.searchData.includes(e);
            t.split(" ").reduce((t, s) => {
              let i = false, a = null, n = null;
              ...
              return t && i;
            }, true) && !i ? (e.searchIndex = s, this.searchData.push(s)) : e.searchIndex = null;
          }), this.wrapper.classList.add("search-results"), this.searchData.length ? this.update() : (this.wrapper.classList.remove("search-results"), this.setMessage(this.options.labels.noResults)), void this.emit("datatable.search", t, this.searchData)) : (this.searching = false, this.update(), this.emit("datatable.search", t, this.searchData), this.wrapper.classList.remove("search-results"), false));
        }
        page(t) {
        ...
        insert(t) {
          ...
          if (i(t)) {
            if (t.headings && !this.hasHeadings && !this.hasRows) {
              ...
              t.headings.forEach(t => {
                const s = a("th", {html: t});
                e.appendChild(s);
              }), this.head.appendChild(e), this.header = e, this.headings = [].slice.call(e.cells), this.hasHeadings = true, this.options.sortable = this.initialSortable, this.render("header"), this.activeHeadings = this.headings.slice();
            }
          ...
          e.length && (this.rows().add(e), this.hasRows = true), this.update(), this.setColumns(), this.fixColumns();
        }
        refresh() {
          this.options.searchable && (this.input.value = "", this.searching = false), this.currentPage = 1, this.onFirstPage = true, this.update(), this.emit("datatable.refresh");
        }
        clear(t) {
        ...
        export(t) {
          ...
          let n, r, o, h;
          if (!i(t)) return false;
          const l = {download: true, skipColumn: [], lineDelimiter: "\n", columnDelimiter: ",", tableName: "myTable", replacer: null, space: 4, ...t};
          if (l.type) {
        ...
        print() {
          const t = this.activeHeadings, e = this.activeRows, s = a("table"), i = a("thead"), n = a("tbody"), r = a("tr");
          t.forEach(t => {
